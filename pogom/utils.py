...
def get_args():
    ...
    """
        new codes start
    """
    parser.add_argument('-cl', '--coorlist',
                            help='Set to determine which coordinate list to use',
                            type=int, default=0)
    """
        new codes end
    """
    ...
    if args.only_server:
        ...
        """
        # print args.coorlist
        # print type(args.coorlist)
        # print args.username, type(args.username)
        # print args.password, type( args.password)
        # print args.step_limit, type(args.step_limit)
        # print args.location, type(args.location)
        # print args.host, type(args.host)
        # print args.port, type(args.port)
        if (str(args.coorlist) == "1"):
            args.username = ["poketotti901"]
            args.password = ["forzaroma"]
            args.step_limit = 6.5
            args.location = u"34.4155, -119.845286"
            args.host = "0.0.0.0"
            args.port = 5999
        if (str(args.coorlist) == "2"):
            args.username = ["poketotti902"]
            args.password = ["forzaroma"]
            args.step_limit = 6.5
            args.location = u"34.4155, -119.845286"
            args.host = "0.0.0.0"
            args.port = 5998
        if (str(args.coorlist) == "3"):
            args.username = ["poketotti903"]
            args.password = ["forzaroma"]
            args.step_limit = 6.5
            args.location = u"34.4155, -119.845286"
            args.host = "0.0.0.0"
            args.port = 5997
        if (str(args.coorlist) == "4"):
            args.username = ["poketotti904"]
            args.password = ["forzaroma"]
            args.step_limit = 6.5
            args.location = u"34.4155, -119.845286"
            args.host = "0.0.0.0"
            args.port = 5996
        if (str(args.coorlist) == "5"):
            args.username = ["poketotti905"]
            args.password = ["forzaroma"]
            args.step_limit = 6.5
            args.location = u"34.4155, -119.845286"
            args.host = "0.0.0.0"
            args.port = 5995
        if (str(args.coorlist) == "6"):
            args.username = ["poketotti906"]
            args.password = ["forzaroma"]
            args.step_limit = "6.5"
            args.location = u"34.4155, -119.845286"
            args.host = "0.0.0.0"
            args.port = 5994
        if (str(args.coorlist) == "7"):
            args.username = ["poketotti907"]
            args.password = ["forzaroma"] 
            args.step_limit = "6.5"
            args.location = u"34.4155, -119.845286"
            args.host = "0.0.0.0"
